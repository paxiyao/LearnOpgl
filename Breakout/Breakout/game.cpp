...
void Game::Init()
{
	...
	ResourceManager::LoadShader("shaders/particle/particle.v.glsl", "shaders/particle/particle.f.glsl", nullptr, "particle");
	ResourceManager::LoadShader("shaders/post_processing/post_processing.v.glsl", "shaders/post_processing/post_processing.f.glsl", nullptr, "postprocessing");
	ResourceManager::LoadShader("shaders/text_render/text_render.v.glsl", "shaders/text_render/text_render.f.glsl", nullptr, "text_render");
	// Configure shaders
	...
	Text = new TextRenderer(ResourceManager::GetShader("text_render"), this->Width, this->Height);
...
void Game::Render()
{
	if (this->State == GAME_ACTIVE || this->State == GAME_MENU || this->State == GAME_WIN)
	{
		...
		std::stringstream ssLive; ssLive << this->Lives;
		Text->RenderText("Lives:" + ssLive.str(), 690, 5.0f, 1.0f);
		std::stringstream ssLevel; ssLevel << this->Level + 1;
		Text->RenderText("Level:" + ssLevel.str(), 5.0f, 5.0f, 1.0f);
	}
	if (this->State == GAME_MENU)
	{
