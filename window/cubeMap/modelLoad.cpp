...
int main()
{
	...
	// -------------------------
	Shader ourShader("1.model_loading_vertex.glsl", "1.model_loading_fragment.glsl");
	Shader skyboxShader("6.4.skybox_vertex.glsl", "6.4.skybox_fragment.glsl");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// don't forget to enable ourShader before setting uniforms
		ourShader.use();
