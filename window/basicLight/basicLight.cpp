...
int main()
{
	...
	// ------------------------------------
	Shader lightingShader("2.1.1.object.vertex.glsl", "2.1.1.object.fragment.glsl");
	Shader lampShader("2.1.1.light.vertex.glsl", "2.1.1.light.fragment.glsl");
   ...
   // -----------
	while (!glfwWindowShouldClose(window))
	{
		...
		// when using irregular scaling. if we havn't use normal matrix, normal vector can't vertical object surface layer
		//model = glm::scale(model, glm::vec3(0.8f, 1.2f, 1.0f));
