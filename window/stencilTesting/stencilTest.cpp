...
int main()
{
	...
	// -------------------------
	Shader shader("1.1.stencil_testing_vertex.glsl", "1.1.stencil_testing_fragment.glsl");
	Shader shaderSingleColor("1.1.stencil_testing_vertex.glsl", "shaderSingleColor.glsl");
