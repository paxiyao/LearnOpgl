...
int main()
{
	...
	// -------------------------
	Shader shader("1.1.faceCulling_vertex.glsl", "1.1.faceCulling_fragment.glsl");
	...
	unsigned int grassTexture = loadTexture(FileSystem::getPath("textures/grass.png").c_str());
