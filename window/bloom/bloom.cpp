...
int main()
{
	...
	// -------------------------
	Shader shader("7.bloom.v.glsl", "7.bloom.f.glsl");
	Shader shaderLight("7.bloom.v.glsl", "7.light_box.f.glsl");
	Shader shaderBlur("7.blur.v.glsl", "7.blur.f.glsl");
	Shader shaderBloomFinal("7.bloom_final.v.glsl", "7.bloom_final.f.glsl");
